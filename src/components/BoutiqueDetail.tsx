...
import { Heart, Instagram, Globe, MapPin, ArrowLeft, CheckCircle2, UserPlus, Users, FolderHeart, Calendar, MessageSquare, Check, Plus } from 'lucide-react';
...
export default function BoutiqueDetail({
  ...
  const boutiqueCollections = mockCollections.filter(c => c.boutiqueId === boutique.id);
        ...
        <div className="mt-8">
          ...
          {activeTab === 'about' && (
            <div className="max-w-3xl mx-auto space-y-8 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-luxury-border font-mono text-xs uppercase tracking-wider">
                <div className="space-y-4">
